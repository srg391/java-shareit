...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> getBookingOfOwner(long userId, BookingState state, Integer from, Integer size) {
        Map<String, Object> parameters = Map.of(
                "state", state.name(),
                "from", from,
                "size", size
    ...
    public ResponseEntity<Object> bookingItem(long userId, BookingItemRequestDto bookingItemRequestDto) {
